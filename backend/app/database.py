...
def get_all_meetings(start_date: Optional[str] = None, end_date: Optional[str] = None) -> List[Dict[str, Any]]:
    conn = get_db_connection()
    cursor = conn.cursor()
...
def create_meeting(title: str, description: Optional[str], start_time: str, end_time: str, participants: List[str]) -> Dict[str, Any]:
    conn = get_db_connection()
    cursor = conn.cursor()
